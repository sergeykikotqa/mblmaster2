...
const PRODUCTION_SECRET_PATTERN =
  /PRODUCTION_MONITOR_|TELEGRAM_(?:BOT_TOKEN|CHAT_ID)|secrets\.(?:REDIS_URL|CONTACT_WORKER_TOKEN|CONTACT_WEBHOOK_SECRET|TURNSTILE_SECRET_KEY|METRICS_ADMIN_TOKEN)/;
