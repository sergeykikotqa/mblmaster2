...
const PRODUCTION_SECRET_PATTERN =
  /PRODUCTION_MONITOR_|TELEGRAM_(?:BOT_TOKEN|CHAT_ID)|MBL_TELEGRAM_ADMIN|MBL_OWNER_METRICS_TOKEN|secrets\.(?:REDIS_URL|CONTACT_WORKER_TOKEN|CONTACT_WEBHOOK_SECRET|SMARTCAPTCHA_SERVER_KEY|METRICS_ADMIN_TOKEN|MBL_OWNER_METRICS_TOKEN)/;
